...
define("YOUTUBE_autohide", "Fortschrittsbalken automatisch verbergen");
define ("YOUTUBE_autoplay", "Video automatisch abspielen");
define("YOUTUBE_theme", "Design des Steuerleiste");
define("YOUTUBE_disablekb", "Tastatursteuerung des Players deaktivieren");
define("YOUTUBE_hide_iv_load_policy", "Videoanmerkungen ausblenden");
define("YOUTUBE_modestbranding", "YouTube-Logo auf Kontrollleiste ausblenden");
define("YOUTUBE_hide_showinfo", "Videotitel und -upload vor Start der Wiedergabe ausblenden");
define("YOUTUBE_color", "Farbe der Fortschrittsleiste");
define("YOUTUBE_controls", "Anzeige der Leiste mit Steuerelementen");

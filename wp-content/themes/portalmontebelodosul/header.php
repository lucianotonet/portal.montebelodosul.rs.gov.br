...
$fonts = array("'Open+Sans:400,700:{$charset}'", "'Dosis:400,700:{$charset}'", "'Nunito:400,700,300:{$charset}'", "'Montserrat:400,700:{$charset}'", "'Lato:400,900,700,300:{$charset}'");
$fonts = implode(", ", $fonts);
?>
...
?>
			<header class="body-header">
				<div class="navbar  navbar-inverse  navbar-fixed-top <?php echo 'sticky' === get_theme_mod('navbar_position', 'sticky') ? ' js--navbar' : '';
echo 'mobile' !== $tap_to_call_visibility ? '  more-down' : ''; ?>">
					<div class="container">
